...
if(isset($_POST["submit"]))
{
    ...
    else
    {
        ...
        $query = mysqli_query($db, "INSERT INTO users (firstname, lastname, username, password email)VALUES ('$firstname1','$lastname1','$username','$password', '$email', '$phone')")or die(mysqli_error($db));
        if($query)
        {
