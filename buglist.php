...
while ($row=mysqli_fetch_assoc($result)){
    ...
    echo '<table border="1" style="width:60%">'.'<col width="auto">'. '<col width="auto">'.'<col width="auto">'.'<tr>'.'<th>
    <a href="mybugs.php?id='.$bugID.'">'.$bugTitle.'</a>'.'</th>'.'<th>'.$bugID.'</th>'.'<th>' . $bugTitle.'</th>'.'<th>'.
